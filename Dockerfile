...
ARG TARGETARCH
ARG BUILDPLATFORM
WORKDIR /go/src/github.com/denizkoekden/process-exporter
ADD . .
...
COPY --from=build /go/src/github.com/denizkoekden/process-exporter/process-exporter /bin/process-exporter
