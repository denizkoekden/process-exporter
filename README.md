...
[release]: https://github.com/denizkoekden/process-exporter/releases/latest

[![Release](https://img.shields.io/github/release/denizkoekden/process-exporter.svg?style=flat-square")][release]
...
![Build](https://github.com/denizkoekden/process-exporter/actions/workflows/build.yml/badge.svg)
...
install via [docker](https://hub.docker.com/r/denizkoekden/process-exporter/).
...
```
  docker run -d --rm -p 9256:9256 --privileged -v /proc:/host/proc -v `pwd`:/config denizkoekden/process-exporter --procfs /host/proc -config.path /config/filename.yml
